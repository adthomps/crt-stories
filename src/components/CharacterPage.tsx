      ...
      >
        ...
        >
          ...
          {character.aliases?.length ? (
            <FactsList label="Aliases" items={character.aliases} />
          ) : null}
          {character.bio?.origin ? (
            <div style={{ marginTop: 8 }}>
              <b>Origin:</b> {character.bio.origin}
            </div>
          ) : null}
          <FactsList
            label="Titles / Ranks"
            items={character.bio?.titlesOrRanks}
          />
