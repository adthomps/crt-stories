...
export default function WorkerCharactersPage() {
  ...
  const [showCount, setShowCount] = useState(20); // Pagination: number to show
      ...
      {!loading && !error && (
        ...
        >
          ...
          >
            ...
            <tbody>
              {characters.slice(0, showCount).map((c, i) => (
                <tr
                  key={c.slug}
                  style={{
      ...
      {modalOpen && (
        ...
        >
          ...
          >
            ...
            >
              {modalMode === "add" ? "Add Character" : "Edit Character"}
            </h2>
            <fieldset
              style={{
            ...
            >
              ...
              <label style={{ fontWeight: 500 }}>
                ...
                <div style={{ fontSize: 12, color: "#888" }}>
                  Select the world this character belongs to (optional).
                </div>
              </label>
            </fieldset>
            <fieldset
            ...
            >
              ...
              <label style={{ fontWeight: 500 }}>
                ...
                <div style={{ fontSize: 12, color: "#888", marginTop: 2 }}>
                  Checked: Character is visible on the public site. Unchecked:
                  Character is hidden (draft).
                </div>
              </label>
            </fieldset>
