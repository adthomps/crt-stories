...
export default function WorkerWorldsPage() {
  ...
  const [form, setForm] = useState<World>({
    slug: "",
    title: "",
    description: "",
    published: false,
  ...
  const openModal = (mode: "add" | "edit", w?: World) => {
    ...
    setForm(
      w ? { ...w } : { slug: "", title: "", description: "", published: false }
    );
    setModalOpen(true);
  };
  const closeModal = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch("/api/worker/worlds", {
        method,
      ...
      {!loading && !error && (
        ...
        >
          ...
          >
            ...
            <tbody>
              {worlds.slice(0, showCount).map((w, i) => (
                <tr
                  key={w.slug}
                  style={{
      ...
      {modalOpen && (
        ...
        >
          ...
          >
            ...
            >
              {modalMode === "add" ? "Add World" : "Edit World"}
            </h2>
            <fieldset
              style={{
            ...
            >
              ...
              <label style={{ fontWeight: 500 }}>
                ...
                <input
                  ...
                  placeholder="e.g. Tales of the Labyrinth Nebula"
                />
              </label>
              <label style={{ fontWeight: 500 }}>
                Slug
                <input
                  ...
                  placeholder="e.g. labyrinth-nebula"
                  pattern="^[a-z0-9-]+$"
                  maxLength={64}
                />
                <div style={{ fontSize: 12, color: "#888" }}>
                  Lowercase, alphanumeric, hyphens only. Example:{" "}
                  <code>labyrinth-nebula</code>
                </div>
              </label>
            </fieldset>
            <fieldset
            ...
            >
              ...
              <label style={{ fontWeight: 500 }}>
                ...
                <div style={{ fontSize: 12, color: "#888", marginTop: 2 }}>
                  Checked: World is visible on the public site. Unchecked: World
                  is hidden (draft).
                </div>
              </label>
            </fieldset>
